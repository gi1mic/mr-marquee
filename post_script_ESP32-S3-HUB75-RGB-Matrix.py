...
command = [ '--chip', 'esp32-s3', 
        'merge-bin',
        '--output', 'mister-fpga\\mr-marquee\\esp_tools\\firmware-mr-marquee-ESP32-S3-HUB75Waveshare.bin',
        '--flash-mode', 'dio', 
        '0x0000', '.pio\\build\\ESP32-S3-HUB75-RGB-Matrix\\bootloader.bin',
        '0x8000', '.pio\\build\\ESP32-S3-HUB75-RGB-Matrix\\partitions.bin',
